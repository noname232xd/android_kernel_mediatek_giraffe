...
// Modify.
#include "include/ITO/NASA5/open_test_ANA1_B_nasa.h"
#include "include/ITO/NASA5/open_test_ANA1_nasa.h"
#include "include/ITO/NASA5/open_test_ANA2_B_nasa.h"
#include "include/ITO/NASA5/open_test_ANA2_nasa.h"
#include "include/ITO/NASA5/open_test_ANA3_nasa.h"

#include "include/ITO/NASA5/short_test_ANA1_nasa.h"
#include "include/ITO/NASA5/short_test_ANA2_nasa.h"
#include "include/ITO/NASA5/short_test_ANA3_nasa.h"
#include "include/ITO/NASA5/short_test_ANA4_nasa.h"
...
static u16 _DrvMpTestItoTestChooseTpType(void)
{
    ...
    if (TP_OF_X == nTpType) // Modify. 
    {
#if defined(CONFIG_ENABLE_CHIP_MSG21XXA)
        _gOpen1 = open_1_nasa;
        _gOpen1B = open_1B_nasa;
        _gOpen2 = open_2_nasa;
        _gOpen2B = open_2B_nasa;
        _gOpen3 = open_3_nasa;

        _gShort_1 = short_1_nasa;
        _gShort_2 = short_2_nasa;
        _gShort_3 = short_3_nasa;
        _gShort_4 = short_4_nasa;

        _gShort_1_GPO = short_1_nasa_GPO;
        _gShort_2_GPO = short_2_nasa_GPO;
        _gShort_3_GPO = short_3_nasa_GPO;
        _gShort_4_GPO = short_4_nasa_GPO;
#elif defined(CONFIG_ENABLE_CHIP_MSG22XX)
        _gOpenRIU1 = open_1_X;
        _gOpenRIU2 = open_2_X;
        _gOpenRIU3 = open_3_X;
        ...
        _gMAP2 = MAP2_nasa;
        _gMAP3 = MAP3_nasa;
        _gMAP40_1 = MAP40_1_nasa;
        _gMAP40_2 = MAP40_2_nasa;
        _gMAP40_3 = MAP40_3_nasa;
        _gMAP40_4 = MAP40_4_nasa;
        _gMAP41_1 = MAP41_1_nasa;
        _gMAP41_2 = MAP41_2_nasa;
        _gMAP41_3 = MAP41_3_nasa;
        _gMAP41_4 = MAP41_4_nasa;

        _gSHORT_MAP1 = SHORT_MP1_nasa;
        _gSHORT_MAP2 = SHORT_MP2_nasa;
        _gSHORT_MAP3 = SHORT_MP3_nasa;
        _gSHORT_MAP4 = SHORT_MP4_nasa;
        
        _gItoTestKeyNum = NUM_KEY_NASA;
        _gItoTestDummyNum = NUM_DUMMY_NASA;
        _gItoTestTriangleNum = NUM_SENSOR_NASA;
        _gIsEnable2R = ENABLE_2R_NASA;
    }
